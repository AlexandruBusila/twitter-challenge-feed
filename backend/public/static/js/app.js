...
define('text!app/template.html',[],function () { return '\r\n<nav\r\n  class="app-navbar navbar navbar-default navbar-fixed-top"\r\n  role="navigation">\r\n</nav>\r\n\r\n\r\n<div\r\n  class="app-content">\r\n</div>\r\n';});
...
define('text!app/navbar/template.html',[],function () { return '\n<div class="whatever"></div>\n';});


define('app/navbar/layout-view',[
  "marionette",
  "text!app/navbar/template.html"
], function (Marionette, NavbarTemplate) {
...
define('app/navbar/service',[
  "components/service",
  "app/navbar/layout-view"
], function (ServiceComponent, NavbarLayoutView) {

  return ServiceComponent.extend({

    onStart: function () {
      this.container.show(new NavbarLayoutView());
    }
...
requirejs([
  ...
  "app/navbar/service"//,
  //"app/tweets/service"
], function (Config, Application, NavbarService) {

  Application.start();

  Application.navbarService = new NavbarService({
    container: Application.layout.navbarRegion
  });
